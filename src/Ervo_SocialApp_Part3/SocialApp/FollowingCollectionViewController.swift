...
//  SocialApp
//
//  Created by Студент on 15/03/2017.
...
class FollowingCollectionViewController: UICollectionViewController {
    ...
    */
    ...
    func retrieveUsers() {
        ...
        if let request = SLRequest(forServiceType: SLServiceTypeTwitter, requestMethod: SLRequestMethod.GET, url: requestURL, parameters: nil) {
